...
exports.ox_target:addModel(Config.TargetOptions.Models.model1, {label = Config.Lang['target_label'], icon = Config.TargetOptions.Main.TargetIcon, event = 'hx_atmRobbery:client:rob'})
exports.ox_target:addModel(Config.TargetOptions.Models.model2, {label = Config.Lang['target_label'], icon = Config.TargetOptions.Main.TargetIcon, event = 'hx_atmRobbery:client:rob'})
exports.ox_target:addModel(Config.TargetOptions.Models.model3, {label = Config.Lang['target_label'], icon = Config.TargetOptions.Main.TargetIcon, event = 'hx_atmRobbery:client:rob'})
exports.ox_target:addModel(Config.TargetOptions.Models.model4, {label = Config.Lang['target_label'], icon = Config.TargetOptions.Main.TargetIcon, event = 'hx_atmRobbery:client:rob'})
